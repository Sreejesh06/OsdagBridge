...
export default function CustomLoadTab({ form, updateField }: CustomLoadTabProps) {
  ...
  return (
    <>
      <div style={{ fontSize: 14, fontWeight: 700, marginBottom: 15 }}>Custom Load:</div>
      ...
      {/* Load list */}
      {items.length > 0 && (
        <div style={{ border: "1px solid #ccc", borderRadius: 8, background: "#fff", padding: "10px 14px" }}>
          <div style={{ fontWeight: 600, fontSize: 12, marginBottom: 8 }}>Custom Loads Added:</div>
